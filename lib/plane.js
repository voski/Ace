(function() {
	...
	Plane.HYPER_PERIOD = Plane.period *3;
	Plane.ROD_LENGTH_PERIOD = Plane.period * 1.5;
...
//
	...
	Plane.prototype.drawPath = function (gameCtx, paintCtx, history, repeat) {
			...
			paintCtx.fillRect( Math.round(this.rod[0] * 10) / 10  , Math.round(this.rod[1] * 10) / 10, 10, 10)
