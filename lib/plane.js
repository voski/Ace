(function() {
	...
	Plane.ROD_LENGTH_PERIOD = Plane.period * 8;
	...
	Plane.prototype.updateRod = function() {
		...
		var length = Plane.ROD_LENGTH  * Math.sin(theta2);
...
//
    ...
    gameCtx.fill();
		...
		this.drawPath(gameCtx, paintCtx, this._path, 150);

  };
	Plane.prototype.drawPath = function (gameCtx, paintCtx, history, repeat) {
			paintCtx.fillStyle = this.color = this.randomcolor()
			...
			paintCtx.fillRect(this.rod[0]  ,this.rod[1] , 1, 1)
